...
package sifive.fpgashells.shell.xilinx.vcu128shell
...
import sifive.fpgashells.ip.xilinx.{IBUFDS, PowerOnResetFPGAOnly, sdio_spi_bridge, vcu128_sys_clock_mmcm0,
                                    vcu128_sys_clock_mmcm1, vcu128reset}

//-------------------------------------------------------------------------
// VCU128Shell
//-------------------------------------------------------------------------

trait HasDDR3 { this: VCU128Shell =>
  
  require(!p.lift(MemoryXilinxDDRKey).isEmpty)
  val ddr = IO(new XilinxVCU128MIGPads(p(MemoryXilinxDDRKey)))
  
  def connectMIG(dut: HasMemoryXilinxVCU128MIGModuleImp): Unit = {
    // Clock & Reset
    dut.xilinxvcu128mig.c0_sys_clk_i := sys_clock.asUInt
    mig_clock                    := dut.xilinxvcu128mig.c0_ddr4_ui_clk
    mig_sys_reset                := dut.xilinxvcu128mig.c0_ddr4_ui_clk_sync_rst
    dut.xilinxvcu128mig.c0_ddr4_aresetn   := mig_resetn
    dut.xilinxvcu128mig.sys_rst   := sys_reset

    ddr <> dut.xilinxvcu128mig
  }
}

abstract class VCU128Shell(implicit val p: Parameters) extends RawModule {
  ...
  //25MHz and multiples
  val vcu128_sys_clock_mmcm0 = Module(new vcu128_sys_clock_mmcm0)
  vcu128_sys_clock_mmcm0.io.clk_in1 := sys_clock.asUInt
  vcu128_sys_clock_mmcm0.io.reset   := reset
  val clk12_5              = vcu128_sys_clock_mmcm0.io.clk_out1
  val clk25                = vcu128_sys_clock_mmcm0.io.clk_out2
  val clk37_5              = vcu128_sys_clock_mmcm0.io.clk_out3
  val clk50                = vcu128_sys_clock_mmcm0.io.clk_out4
  val clk100               = vcu128_sys_clock_mmcm0.io.clk_out5
  val clk150               = vcu128_sys_clock_mmcm0.io.clk_out6
  val clk75                = vcu128_sys_clock_mmcm0.io.clk_out7
  val vcu128_sys_clock_mmcm0_locked = vcu128_sys_clock_mmcm0.io.locked

  //65MHz and multiples
  val vcu128_sys_clock_mmcm1 = Module(new vcu128_sys_clock_mmcm1)
  vcu128_sys_clock_mmcm1.io.clk_in1 := sys_clock.asUInt
  vcu128_sys_clock_mmcm1.io.reset   := reset
  val clk32_5              = vcu128_sys_clock_mmcm1.io.clk_out1
  val clk65                = vcu128_sys_clock_mmcm1.io.clk_out2
  val vcu128_sys_clock_mmcm1_locked = vcu128_sys_clock_mmcm1.io.locked
  ...
  do_reset             := !mig_mmcm_locked || !mmcm_lock_pcie || mig_sys_reset || !vcu128_sys_clock_mmcm0_locked ||
                          !vcu128_sys_clock_mmcm1_locked
  ...
  val safe_reset = Module(new vcu128reset)
